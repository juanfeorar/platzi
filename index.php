...
<body>
  <div class="container">
    <div id="resume-header" class="row">
      ...
      <div class="col">
        <h1> <?php echo $name; ?> </h1>
        <h2>PHP Developer, JS Developer</h2>
        <ul>
          <li>Mail: juanfeorar@gmail.com</li>
          <li>Phone: 3003355490</li>
          <li> <a href="https://www.linkedin.com/in/juanfeorar/"> LinkedIn: https://www.linkedin.com/in/juanfeorar/</a></li>
          <li>Twitter: @juanfeorar</li>
        </ul>
      </div>
    </div>
    <div class="row">
